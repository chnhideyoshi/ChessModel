...
**
** Created: Wed Feb 12 18:39:52 2014
...
static const char qt_meta_stringdata_Thread[] = {
    "Thread\0\0currentChessBoard\0ShowMap(ChessBoard)\0"
    "message\0ShowMessageOnWorkingThread(QString)\0"
    "data\0GetInputData(InputData)\0"
};
...
int Thread::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: ShowMap((*reinterpret_cast< const ChessBoard(*)>(_a[1]))); break;
        case 1: ShowMessageOnWorkingThread((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 2: GetInputData((*reinterpret_cast< const InputData(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 3;
    }
...
// SIGNAL 0
void Thread::ShowMap(const ChessBoard & _t1)
{
...
// SIGNAL 1
void Thread::ShowMessageOnWorkingThread(const QString & _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
